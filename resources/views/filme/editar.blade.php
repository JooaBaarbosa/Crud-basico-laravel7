...
<body>
    <div class="container">
        ...
        <form action="{{route('alterar_filme', $filme->id)}}" method="post">
          @csrf
            <div class="form-group">
                <label for="nomefilme">Filme</label>
                <input type="text" class="form-control" name="nomefilme" id="nomefilme" value="{{old('nomefilme',$filme->nomefilme)}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="categoriafilme" id="categoriafilme" value="{{old('categoriafilme',$filme->categoriafilme)}}">
